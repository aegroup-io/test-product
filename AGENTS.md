...
Canonical copy: `docs/ops/AGENTS.md`.
...
- Harness workflows: `docs/harness/README.md`
- Planning area: `docs/planning/README.md`
- Issue and PR rules: `docs/ops/PROJECT_PLANNING.md`

## Core Rules
- Use `gh` for issues, pull requests, and project operations.
- One pursued issue = one worktree off `dev` = one branch = one PR lane.
- If another coding lane may run at the same time, do not work from the shared repo checkout; create a dedicated worktree first and use `docs/harness/worktree-bootstrap.md`.
